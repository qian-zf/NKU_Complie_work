    ...
    for file in os.listdir(input_folder):
        if(file.endswith(".sy")):
            ...
            if(os.path.exists(input_folder + '/' + name + ".in")):
                success = execute_ir(input_folder+'/'+file, output_folder+'/'+name+".ll", opt_arg, input_folder+'/'+input, input_folder+'/'+output, "tmp.out")
            else:
                success = execute_ir(input_folder+'/'+file, output_folder+'/'+name+".ll", opt_arg, "none", input_folder+'/'+output, "tmp.out")
